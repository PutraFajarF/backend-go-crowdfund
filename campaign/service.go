...
type Service interface {
	...
	Update(input GetCampaignDetailInput, inputData CreateCampaignInput) (Campaign, error)
}
...
func (s *service) Update(input GetCampaignDetailInput, inputData CreateCampaignInput) (Campaign, error) {
